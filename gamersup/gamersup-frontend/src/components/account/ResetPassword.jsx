...
function ResetPassword() {
  ...
  const handleResetSubmit = (e) => {
    ...
    if (e.target.newpassword.value.length < 8) {
      ...
      setAlertWithTimeout('Your new passwords must match', 'information');
    } else {
      changePassword(
        ...
        .catch((error) => {
          setAlertWithTimeout('Your current password is not match!', 'error');
        });
    }
  };
            ...
            <form className='mt-8 space-y-6' onSubmit={handleResetSubmit}>
              ...
              <div className='flex justify-center'>
                ...
                <div>
                  <Link
                    to='/'
                    className='group relative w-auto mx-5 px-10 border border-transparent text-base font-medium rounded btn btn-neutral focus:ring-2 focus:ring-offset-2 focus:ring-neutral-focus'
                  >
                    Cancel
                  </Link>
                </div>
